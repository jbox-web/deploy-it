...
module Helpers
  module Docker
    ...
    def new_image_from_file(image_source, image_dest, source_file, docker_options = {})
      docker_options = docker_options.merge(new_image_name: image_dest)
      docker_connection.inject_file(image_source, source_file, '/app', nil, { create_parent_dir: true, tar_file: true }, docker_options)
    end
